  ...
  return (
    <div className="bg-gray-50">
      <div className="max-w-7xl mx-auto py-12 px-4 divide-y divide-gray-200 sm:px-6 lg:py-16 lg:px-8">
        <div className="flex w-full justify-center items-center"><h2 className="text-3xl font-extrabold text-gray-900">Foire Aux Questions</h2><Image src="/logo404.png" alt="Logo 404" width="60" height="60" className="ml-5"/></div>
        <div className="mt-8">
